...
class SubjectViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_serializer_class(self):
        if self.action == 'add_subject': 
            return PostSubjectSerializer
        elif self.action == 'edit_subject': 
    ...
    @transaction.atomic
    @action(methods=["delete", "get"], detail=True, url_path="remove-subject")
    ...
    @transaction.atomic
    @action(methods=["patch", "get"], detail=True, url_path="edit-subject")
